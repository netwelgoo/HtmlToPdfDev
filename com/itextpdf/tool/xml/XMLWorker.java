...
//			System.out.println("Bug1 ctx.getCurrentTag()["+ctx.getCurrentTag()+"]");
//			System.out.println("Bug2 thetag["+thetag+"]["+ctx.getCurrentTag().getName()+"]");
			throw new RuntimeWorkerException(String.format(
												LocaleMessages.getInstance().getMessage(LocaleMessages.INVALID_NESTED_TAG), 
												thetag,
