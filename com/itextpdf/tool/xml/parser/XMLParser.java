...
import com.itextpdf.testutils.ParseHtml;
...
//            	buffer.append(read[0]);
            }
        }catch(Exception e){
        	Tracer.error("html to pdf coverting error " +e);
//        	String bs = buffer.toString();
//        	int len = bs.length();
//        	System.out.println("PARSING EXCEPTION POINT = "+bs.substring(bs.length()-100));
//        	buffer.setLength(0);
        	throw e;
        }
        finally {
            ...
            r.close();
            s = ParseHtml.log(s, ">> pdf randering end >>");
        }
    }
...
//FIXME =======================================================
//        System.out.println(this.memory.current().toString());
