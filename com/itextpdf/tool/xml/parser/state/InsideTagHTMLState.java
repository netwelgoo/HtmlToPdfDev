/*
 * $Id: InsideTagHTMLState.java 437 2013-12-23 12:27:00Z blowagie $
 *
...
//FIXME pioneer (2016.02.19)
		ignoreLastChars.add(HTML.Tag.BOOKMARK);
	}
	...
	public void process(final char character) {
		if (character == '<') {
			...
			String tag = this.parser.currentTag(); //tag Name
			TagState state = this.parser.currentTagState(); //tag 상태
