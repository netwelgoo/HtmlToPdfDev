        ...
        boolean process(Token t, HtmlTreeBuilder tb) {
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    String name = startTag.name();
                    if(name.equals("list")){
                    	System.out.println("StartTagName["+name+"]");
                    }
                    if (name.equals("a")) {
...
//                    else if (StringUtil.inSorted(name, Constants.InBodyFremarkerFormatters)) {
...
//                    }
    ...
    private static final class Constants {
        ...
        private static final String[] InBodyFremarkerFormatters = new String[]{ // "#assign", "#break", "#compress", "#else", "#list", "#if", "#macro", "#setting",     
        																		"assign", "break", "compress", "else", "if", "list", "macro", "setting" };
    }
}
