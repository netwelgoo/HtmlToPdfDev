 ...
 *
 */
public class FontContainer2 {
	
	private static FontContainer2 uniqueFontContainer = new FontContainer2();
	...
	public static void main1(String[] args) {
		FontContainer2 fc = FontContainer2.getInstance();
